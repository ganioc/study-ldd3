/*
 * Definitions of the char module
...
/* 
* The pipe device is a simple circular buffer. it's default size
*/
...
/*
    ...
    T means "Tell" directly with the arguemnt value
