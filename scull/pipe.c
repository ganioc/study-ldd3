...
static unsigned int scull_p_poll(struct file *filp, poll_table *wait){
	 ...
	 * if "wp" is right behind "rp" and empty if the two
	 * are equal.
	 */
	mutex_lock(&dev->lock);
...
#define LIMIT (PAGE_SIZE -200) /* dont print any more after this size */
...
/*
 * Initialize the pipe devs; return how may we did.
 */
