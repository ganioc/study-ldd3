...
static int scull_s_release(struct inode *inoode, struct file *filp){
...
/* looking for a device or create one if missing */
...
static int scull_c_release(struct inode *inode, struct file *filp){
	 ...
	 * A 'real' clone device should be freed on last close
	 */
	return 0;
}
